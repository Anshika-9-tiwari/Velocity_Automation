...
const Delta = () => {
  ...
  {
    title: 'Delta HMI',
    description: 'We understand need of customer & deliver  all HMI Like- Basic Panels 1st Gen, Basic Panels 2nd Gen, Comfort Panels 1st Gen - Standard devices',
    image: 'https://atechnology.in/wp-content/uploads/2023/04/CPMFORT-PANEL-PHOTO-removebg-preview.jpg',
  },
  {
    title: 'Delta AC Drive',
    description: 'We serve all Delta AC Drives like V20, G120, G120C etc',
            ...
            <motion.div whileHover={{ scale: 1.03 }}>
              ...
              >
                ...
                <div className="p-5 space-y-3 ">
                  ...
                  <p className="text-orange-500 italic">{training.description}</p>
                </div>
              </div>
            </motion.div>
          ))}
